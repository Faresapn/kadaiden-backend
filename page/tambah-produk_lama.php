			...
			<div class="panel panel-default">
				...
				<div class="panel-body">                                                                        
					...
					<div class="row">
						...
						<div class="form-group">                                        
							<label class="col-md-2 control-label">Tanggal Izin Edar</label>
							<div class="col-md-7">
								<div class="input-group">
									<span class="input-group-addon"><span class="fa fa-calendar"></span></span>
									<input type="text" class="form-control datepicker" name="tanggal_izin_edar" required/>       
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">                                            
								<div class="input-group">
									...
									<input type="text" name="harga_modal" class="form-control" required/>
								</div>                                            
							</div>
						</div>
